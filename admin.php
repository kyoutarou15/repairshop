        ...
        <div id="view_dashboard" class="panel_view">
            ...
            <div class="dash_customers">
                <div class="dash_top_bar">
                    <p class="dash_customer_txt">Staff</p>
                </div>
                <div class="dast_table_container">
                    <?php
                        ...
                        {
                            echo '<p style="text-align: center;">No Staff!</p>';
                        }
                    ?>
                </div>
            </div>
        ...
        <div id="view_appointment" class="panel_view">
            <form action="submit.php" method="post"  class="appn_panel">
                ...
                <div class="appn_panel_cont appn_left">
                    ...
                    <input class="appn_item appn_inp_box" type="text" name="staff_name" placeholder="Enter Staff Name:">
                    <input class="appn_item appn_inp_box" type="number" name="contact" placeholder="Contact Number:">
                    <input class="appn_item appn_inp_box" type="text" name="email" placeholder="Email Address:">
                    <input class="appn_item appn_inp_box" type="password" name="password" placeholder="Password:">

                
                    <button class="appn_submit_a" type="submit">Submit</button>
                </div>
            </form>
        </div>
    </div>
